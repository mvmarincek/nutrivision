...
function GoogleLoginButtonInner({ onSuccess, label = 'Entrar com Google', disabled = false }: GoogleLoginButtonProps) {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 py-4 px-4 border-2 border-gray-200 rounded-2xl bg-white hover:bg-gray-50 hover:border-gray-300 transition-all font-semibold text-gray-700 disabled:opacity-50"
    >
      {loading ? (
